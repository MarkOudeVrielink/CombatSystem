...
#define ORIGINAL_FILE_NAME "UE4Editor-HacknSlashSystem.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME HacknSlashSystem
#define DEPRECATED_FORGAME DEPRECATED
#define HACKNSLASHSYSTEM_API DLLEXPORT
